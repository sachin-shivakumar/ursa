...
class HypothesizerAgent(BaseAgent[HypothesizerState]):
    ...
    def agent1_generate_solution(
        ...
        try:
            raw_search_results = self.search_tool.text(
                search_query or state["question"], backend="duckduckgo",  
            )
        except:
            raw_search_results = "No external results were found for this query."
    ...
    def agent2_critique(self, state: HypothesizerState) -> HypothesizerState:
        ...
        try:
            fact_check_results = self.search_tool.text(fact_check_query, backend="duckduckgo")
        except: 
            fact_check_results = "No external results were found for this query."
    ...
    def agent3_competitor_perspective(
        ...
        try:
            competitor_info = self.search_tool.text(competitor_search_query, backend="duckduckgo")
        except:
            competitor_info = "No external results were found for this query."
